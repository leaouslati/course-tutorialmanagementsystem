        ...
        <section className="w-full max-w-5xl rounded-2xl bg-white shadow-md border border-slate-200 overflow-hidden">
          <div className="px-8 pt-8 pb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button
              ...
              className="self-start sm:self-auto flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold text-white shadow transition-colors duration-300 hover:shadow-lg border-none focus:outline-none focus-visible:outline-none focus:ring-0"
              style={{ backgroundColor: '#1976D2' }}
